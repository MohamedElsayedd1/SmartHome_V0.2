# 1 "mcc_generated_files/24C01C/24C01C.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mcc_generated_files/24C01C/24C01C.c" 2
# 1 "mcc_generated_files/24C01C/24C01C.h" 1
# 11 "mcc_generated_files/24C01C/24C01C.h"
# 1 "mcc_generated_files/24C01C/../../mcc_generated_files/i2c_client/i2c_master_example.h" 1
# 50 "mcc_generated_files/24C01C/../../mcc_generated_files/i2c_client/i2c_master_example.h"
...
# 50 "mcc_generated_files/24C01C/../../mcc_generated_files/i2c_client/i2c_master_example.h" 2
...
# 51 "mcc_generated_files/24C01C/../../mcc_generated_files/i2c_client/i2c_master_example.h" 2

# 1 "mcc_generated_files/24C01C/../../mcc_generated_files/i2c_client/i2c_master.h" 1
# 56 "mcc_generated_files/24C01C/../../mcc_generated_files/i2c_client/i2c_master.h"
# 1 "C:\\Program Files\\Microchip\\xc8\\v2.45\\pic\\include\\c99\\stdbool.h" 1 3
# 56 "mcc_generated_files/24C01C/../../mcc_generated_files/i2c_client/i2c_master.h" 2
...
# 101 "mcc_generated_files/24C01C/../../mcc_generated_files/i2c_client/i2c_master.h"
i2c_error_t I2C_Open(i2c_address_t address);
# 111 "mcc_generated_files/24C01C/../../mcc_generated_files/i2c_client/i2c_master.h"
i2c_error_t I2C_Close(void);
# 123 "mcc_generated_files/24C01C/../../mcc_generated_files/i2c_client/i2c_master.h"
...
# 142 "mcc_generated_files/24C01C/../../mcc_generated_files/i2c_client/i2c_master.h"
void I2C_SetTimeout(uint8_t timeOut);
# 152 "mcc_generated_files/24C01C/../../mcc_generated_files/i2c_client/i2c_master.h"
void I2C_SetBuffer(void *buffer, size_t bufferSize);
# 164 "mcc_generated_files/24C01C/../../mcc_generated_files/i2c_client/i2c_master.h"
void I2C_SetDataCompleteCallback(i2c_callback_t cb, void *ptr);
# 174 "mcc_generated_files/24C01C/../../mcc_generated_files/i2c_client/i2c_master.h"
void I2C_SetWriteCollisionCallback(i2c_callback_t cb, void *ptr);
# 184 "mcc_generated_files/24C01C/../../mcc_generated_files/i2c_client/i2c_master.h"
void I2C_SetAddressNackCallback(i2c_callback_t cb, void *ptr);
# 194 "mcc_generated_files/24C01C/../../mcc_generated_files/i2c_client/i2c_master.h"
void I2C_SetDataNackCallback(i2c_callback_t cb, void *ptr);
# 204 "mcc_generated_files/24C01C/../../mcc_generated_files/i2c_client/i2c_master.h"
...
# 222 "mcc_generated_files/24C01C/../../mcc_generated_files/i2c_client/i2c_master.h"
void I2C_SetInterruptHandler(void (* InterruptHandler)(void));
# 52 "mcc_generated_files/24C01C/../../mcc_generated_files/i2c_client/i2c_master_example.h" 2
...
# 11 "mcc_generated_files/24C01C/24C01C.h" 2
...
void EX_EEPROM_Write_Byte(uint8_t reg, uint8_t data){
    I2C_Write1ByteRegister(0xA2, reg, data);
}

uint8_t EX_EEPROM_Read_Byte(uint8_t reg){
    uint8_t received_data = I2C_Read1ByteRegister(0xA3, reg);
